...
<body>
    ...
    <div class="card text-bg-dark">
        <img src="imgs/mario_e_amigos.jpg" class="card-img img-thumbnail" alt="...">
        <div class="card-img-overlay">
          <h5 class="card-title">G-alexia</h5>
          <p class="card-text">Os melhores jogos estão aqui, se você discorda o problema é seu! :)</p>
    ...
    <div class="card-group row row-cols-1 row-cols-md-3 g-4">
        <div class="card" style="width: 18rem;">
            <img src="./imgs/The-Last-of-Us-2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img src="./imgs/super-mario-bros.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Mario Bros</h5>
              <p class="card-text"> Mario Bros. é um jogo eletrônico de plataforma para arcades criado por Shigeru Miyamoto, desenvolvido pela Nintendo Research & Development 1 e publicado pela Nintendo em 1983. Foi colocado como um minijogo na série Super Mario Advance e em vários outros jogos da franquia.</p>
              <a href="https://www.youtube.com/watch?v=nPOuDZGCZp4" class="btn btn-primary" target="_blank">Veja a melhor gameplay!</a>
            </div>
        </div>
        <div class="card" style="width: 18rem;">
            <img src="./imgs/minecraft.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              ...
              <a href="https://www.youtube.com/watch?v=-MIjyD2flr4&t=273s" class="btn btn-primary" target="_blank">Veja a melhor gameplay!</a>
            </div>
        </div>
        <div class="card" style="width: 18rem;">
            <img src="./imgs/god_of_war.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              ...
              <a href="https://www.youtube.com/watch?v=NhTytzzAkNM" class="btn btn-primary" target="_blank">Veja a melhor gameplay!</a>
            </div> <br> <br>
        </div> <br><br> <br>
    ...
    <div class="card-group row row-cols-1 row-cols-md-3 g-4">
        <div class="card" style="width: 18rem;">
            <img src="./imgs/counter_strike.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img src="./imgs/fortnite.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img src="./imgs/league-of-legends.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img src="./imgs/read_dead_redemption.jpg" class="card-img-top" alt="...">
            <div class="card-body">
